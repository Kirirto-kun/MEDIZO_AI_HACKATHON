...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "min-w-0 max-w-full rounded-lg border border-white/10 bg-card/50 text-card-foreground shadow-lg shadow-black/20 backdrop-blur-md",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "min-w-0 break-words text-2xl font-semibold leading-none tracking-tight [overflow-wrap:anywhere]",
      className
    )}
    {...props}
  />
